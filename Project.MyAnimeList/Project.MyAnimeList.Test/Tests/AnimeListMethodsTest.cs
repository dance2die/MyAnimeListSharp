...
namespace Project.MyAnimeList.Test.Tests
{
        ...
        IClassFixture<AnimeListMethodsFixture>
    {
        ...
        {
            var sut = new AddAnimeRequestParameters(CredentialContextFixture.CredentialContext,
                AnimeValuesFixture.AnimeId, AnimeValuesFixture.Data);
