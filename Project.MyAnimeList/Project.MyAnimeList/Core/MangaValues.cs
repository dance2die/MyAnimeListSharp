    ...
    public class MangaValues : MyAnimeListValues
    {
        ...
        public int TimesReread
        {
            ...
            set
            {
                ...
                if (value > 255)
                    throw new ArgumentOutOfRangeException(nameof(TimesReread),
                        "TimesReread value should be less than or equal to 255");
                _timesReread = value;
            }
        }
        ...
        public int RetailVolumes
        {
            ...
            {
                if (value < 0)
                    throw new ArgumentOutOfRangeException(nameof(RetailVolumes),
                        "RetailVolumes value cannot be negative");
